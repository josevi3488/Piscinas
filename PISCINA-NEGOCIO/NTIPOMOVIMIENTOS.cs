...
namespace PISCINA_NEGOCIO
{
    public class NTIPOMOVIMIENTOS
    {
        ...
        public int CrearUsuario(ETIPOS_MOVIMIENTOS obj, out string Mensaje)
        {
        ...
        public bool EditarUsuario(ETIPOS_MOVIMIENTOS obj, out string Mensaje)
        {
        ...
        public bool EliminarUsuario(ETIPOS_MOVIMIENTOS obj, out string Mensaje)
        {
