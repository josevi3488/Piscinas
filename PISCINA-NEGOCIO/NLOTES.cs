...
namespace PISCINA_NEGOCIO
{
    public class NLOTES
    {
        ...
        public int CrearUsuario(ELOTE_PRODUCTO obj, out string Mensaje)
        {
        ...
        public bool EditarUsuario(ELOTE_PRODUCTO obj, out string Mensaje)
        {
        ...
        public bool EliminarUsuario(ELOTE_PRODUCTO obj, out string Mensaje)
        {
