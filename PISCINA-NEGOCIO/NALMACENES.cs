...
namespace PISCINA_NEGOCIO
{
    public class NALMACENES
    {
        ...
        public int CrearUsuario(EALMACENES obj,out string Mensaje)
        {
        ...
        public bool EditarUsuario(EALMACENES obj, out string Mensaje)
        {
        ...
        public bool EliminarUsuario(EALMACENES obj, out string Mensaje)
        {
