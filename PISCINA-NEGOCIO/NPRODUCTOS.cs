...
namespace PISCINA_NEGOCIO
{
    public class NPRODUCTOS
    {
        ...
        public int CrearUsuario(EPRODUCTOS obj, out string Mensaje)
        {
        ...
        public bool EditarUsuario(EPRODUCTOS obj, out string Mensaje)
        {
        ...
        public bool EliminarUsuario(EPRODUCTOS obj, out string Mensaje)
        {
